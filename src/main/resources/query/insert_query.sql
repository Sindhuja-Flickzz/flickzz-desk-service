...
INSERT INTO FD_COUNTRY_MASTER (COUNTRY_NAME, ISO_CODE, PHONE_CODE, CURRENCY_CODE, CURRENCY_NAME, TIMEZONE,
                               IS_ACTIVE, CREATED_BY, UPDATED_BY, IS_CREATOR_ADMIN)
VALUES ('India', 'IN', '+91', 'INR', 'Indian Rupee', 'Asia/Kolkata', TRUE, 1, 1, TRUE),
...
VALUES ('Tamil Nadu', 'TN', 1, TRUE, 1, 1, TRUE),
...
VALUES ('Chennai', 'CHE', 1, 1, 'Asia/Kolkata', TRUE, 1, 1, TRUE),
...
INSERT INTO FD_WORK_ITEMS (CODE, LABEL, CREATED_BY, IS_CREATOR_ADMIN)
VALUES ('TASK', 'Task', 1, TRUE),
...
VALUES ('TEXTAREA', 'TEXTAREA', 1, TRUE),
...
---------------------------------------- 12/07/2026	----------------------------------------
INSERT INTO FD_TICKET_TYPE_MASTER (TICKET_TYPE_NAME, IS_ACTIVE, CREATED_BY, IS_CREATOR_ADMIN)
VALUES ('Incident', TRUE, 1, TRUE),
