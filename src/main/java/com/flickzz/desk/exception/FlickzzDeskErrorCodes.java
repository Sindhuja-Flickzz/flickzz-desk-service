...
public enum FlickzzDeskErrorCodes implements ErrorCode {
    ...
    UNREAD_ERROR("FD-117", "Unread Notification", "Please mark notification as read before clearing"),
    VERIFY_LIST_PAGE("FD-118", "Verify List Page", "\"%s already exist. Please verify List Page"),
    ;
