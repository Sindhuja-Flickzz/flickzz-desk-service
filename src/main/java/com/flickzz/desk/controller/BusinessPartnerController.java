...
public class BusinessPartnerController {
    ...
    public ResponseEntity<FlickzzDeskResponse> getBusinessPartnerCategoryConfiguration(
        ...
        List<BPCategoryVO> response = businessPartnerService
                .getBusinessPartnerCategoryConfiguration(Long.valueOf(businessPartnerId), INACTIVE);

        log.info(generateLog(EXIT, this.getClass().getName()));
        return handleSuccessResponse(FETCH_SUCCESS, getDescription(FETCH_SUCCESS.getDescription(), CATEGORY), response);
    }

    @GetMapping("/config/category/active/{businessPartnerId}")
    public ResponseEntity<FlickzzDeskResponse> getBusinessPartnerActiveCategoryConfiguration(
            @PathVariable String businessPartnerId) {
        log.info(generateLog(ENTRY, this.getClass().getName()));

        List<BPCategoryVO> response = businessPartnerService
                .getBusinessPartnerCategoryConfiguration(Long.valueOf(businessPartnerId), ACTIVE);
    ...
    public ResponseEntity<FlickzzDeskResponse> getBusinessPartnerSubCategoryConfigurationByCategortyId(@PathVariable Long categoryId) {
        log.info(generateLog(ENTRY, this.getClass().getName()));

        List<BPSubCategoryVO> response = businessPartnerService
                .getBusinessPartnerSubCategoryConfigurationByCategoryId(categoryId);

        log.info(generateLog(EXIT, this.getClass().getName()));
        return handleSuccessResponse(FETCH_SUCCESS, getDescription(FETCH_SUCCESS.getDescription(), "Sub Category"), response);
    }
    ...
    public ResponseEntity<FlickzzDeskResponse> getBusinessPartnerSupportGroupConfigurationBySubCategoryId(@PathVariable Long subCategoryId) {
        log.info(generateLog(ENTRY, this.getClass().getName()));
        BPSupportGroupVO response = businessPartnerService.getBusinessPartnerSupportGroupConfigurationBySubCategoryId(subCategoryId);
        log.info(generateLog(EXIT, this.getClass().getName()));
        return handleSuccessResponse(FETCH_SUCCESS, getDescription(FETCH_SUCCESS.getDescription(), "Sub Category"), response);
    }
